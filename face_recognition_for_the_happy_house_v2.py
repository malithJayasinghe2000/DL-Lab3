...
Original file is located at
    https://colab.research.google.com/drive/1vdt4h0QS6JllRGshWcXrV8r5L0cCmQ4G
...
def resize_image(image_path, target_size=(96, 96)):
    ...
    # Ensure target size is a 1-D tensor with two elements
    target_size_tensor = tf.constant(target_size, dtype=tf.int32)

    # Resize image
    img = tf.image.resize(img, size=target_size_tensor)
...
def img_to_encoding(image_path, model):
    # Prepare image by resizing
    image = resize_image(image_path, target_size=(96, 96))
    # Pass the prepared image to the model for encoding
...
database["shabry"] = img_to_encoding("shabry.JPG", FRmodel)
database["shabry"] = img_to_encoding("shabry2.jpg", FRmodel)
...
verify("shabry.JPG", "shabry", database, FRmodel)

verify("shabry2.jpg", "shabry", database, FRmodel)
